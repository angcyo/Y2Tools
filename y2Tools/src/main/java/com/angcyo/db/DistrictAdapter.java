...
public class DistrictAdapter extends BaseAdapter {
	...
	private List<DistrictListItem> list;

	public DistrictAdapter(Context context, List<DistrictListItem> list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		DistrictListItem dItem = list.get(position);
		item1.setText(dItem.getName());
		item2.setText("");
		item3.setText(dItem.getZip());
